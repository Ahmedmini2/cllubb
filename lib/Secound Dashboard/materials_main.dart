...
class MaterialMain extends StatefulWidget {
  MaterialApp createState() => MaterialApp();

}
class MaterialApp extends State<MaterialMain> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('C Material', style: TextStyle(color: Colors.white , fontFamily: 'BankGR'),),
