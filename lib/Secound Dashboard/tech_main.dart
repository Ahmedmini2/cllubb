...
class TechMain extends StatefulWidget {
  TechApp createState() => TechApp();

}
class TechApp extends State<TechMain> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('C Tech', style: TextStyle(color: Colors.white , fontFamily: 'BankGR'),),
