...
class PropertyMain extends StatefulWidget {
  PropertyApp createState() => PropertyApp();

}
class PropertyApp extends State<PropertyMain> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('C Property', style: TextStyle(color: Colors.white , fontFamily: 'BankGR'),),
