...
class FurnitureMain extends StatefulWidget {
  FurnitureApp createState() => FurnitureApp();

}
class FurnitureApp extends State<FurnitureMain> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('C Furniture', style: TextStyle(color: Colors.white , fontFamily: 'BankGR'),),
