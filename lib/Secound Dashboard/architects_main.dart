...
class ArchitectsMain extends StatefulWidget {
  ArchitectsApp createState() => ArchitectsApp();

}
class ArchitectsApp extends State<ArchitectsMain> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('C Architects', style: TextStyle(color: Colors.white , fontFamily: 'BankGR'),),
