...
class BrandsMain extends StatefulWidget {
  BrandsApp createState() => BrandsApp();

}
class BrandsApp extends State<BrandsMain> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('C Brands', style: TextStyle(color: Colors.white , fontFamily: 'BankGR'),),
